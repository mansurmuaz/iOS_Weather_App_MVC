...
extension HomeViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if !displayingLocations.isEmpty {
            ...
            let lat = displayingLocations[indexPath.row].latitude
            let lon = displayingLocations[indexPath.row].longitude
            weatherProvider.getWeather(dayCount: .one, lat: lat, lon: lon) { (weather) in
